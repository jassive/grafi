(function ($) {
    ...
    /**
     * Aaqui obtuvimos un numero aleatorio
     * @param {integer}
     * @param {integer}
     */
    ...
    /**
     *Limite entre el rango obtenido
    ...
    /**
     * Para poder cargar todas las imagenes
     */
    var assetLoader = (function() {
      // Funcion de nuestras imagenes 
      this.imgs        = {
        'bg'            : 'imgs/bg.png',
        'sky'           : 'imgs/sky.png',
     ...
     //Diccionario de Sonidos
      ...
      /**
       * Asegurar que todos los elementos sean cargados antes de ser utilizados
       * @param {number} dic  
       * @param {number} name 
       */
      ...
      /**
       *Estado listo de un archivo de audio 
       * @param {object} sound 
       */
      ...
      /**
       * Crear activos,establecer la fuente de activos
       */
    ...
    function SpriteSheet(path, frameWidth, frameHeight) {
      ...
      // Calcular fotogramas en una fila despues de carga la imagen
      var self = this;
    ...
    /**
     * Crear animacion apartir de una hoja de calculo
     * @param {SpriteSheet} 
     * @param {number}     
     * @param {array}       
     * @param {boolean}     
    ...
    var background = (function() {
      ...
      /**
       * Fondo de la pantalla a diferentes velocidades
       */
      this.draw = function() {
       ...
       //si la imagen se desplazo por la patntalla , reinicie
